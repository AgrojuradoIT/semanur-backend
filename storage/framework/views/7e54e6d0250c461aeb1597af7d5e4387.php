...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body>
        <div class="container">
            ...
            <footer>
                <?php echo e(config('app.name', 'Semanur')); ?> &mdash; Laravel v<?php echo e(Illuminate\Foundation\Application::VERSION); ?>

            </footer>
        </div>
    </body>
</html>
<?php /**PATH D:\DEV\semanur_app\backend\resources\views/welcome.blade.php ENDPATH**/ ?>